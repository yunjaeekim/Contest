...
#### 역할 : 옥상 풋살장이라는 아이디어를 냈고 서울 유동인구 데이터/ 인구 밀도 데이터/ 각 행정동 별 좌표 데이터를 수집하고 전처리하는 역할을 맡았고 시각화 과정에서 위 데이터 및 지하철 승하차 데이터까지 folium으로 시각화했습니다. 마지막으로 streamlit에서 button/ radio와 같은 전체적인 틀을 만들어 팀원들에게 제공했습니다.
