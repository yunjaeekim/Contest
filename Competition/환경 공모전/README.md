...
- 하지만 도로명 주소를 위/경도로 변환하는 geo-coding 작업과 QGIS에 데이터를 적재하는 과정에서 많은 시간이 소요되었습니다. 이로 인해 입지 분석은 완료되었지만, 저감시설 설치의 구체적인 위치 선정 및 해결 방안에서 결론을 도출하지 못했습니다.(ex. 가로등에 살수기를 달아야한다. or 도로가 주변에 설치해야 한다.) 이랄 통해 데이터 분석 프로세스에서의 시간 관리의 중요성을 더욱 몸소 느낄 수 있었습니다. 
